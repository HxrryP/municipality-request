                    ...
                    <div class="bg-gradient-to-br from-blue-600 to-blue-700 overflow-hidden shadow-sm sm:rounded-xl text-white">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="{{ route('requests.index') }}" class="block bg-white bg-opacity-10 hover:bg-opacity-20 transition p-4 rounded-lg">
                                    <div class="flex items-center">
                                        <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="{{ route('payments.show', ['request' => 1]) }}" class="block bg-white bg-opacity-10 hover:bg-opacity-20 transition p-4 rounded-lg">
                                    <div class="flex items-center">
                                        <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
